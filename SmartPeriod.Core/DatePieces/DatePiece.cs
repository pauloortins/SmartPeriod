...
namespace SmartPeriod.Core.DatePieces
{
    public abstract class DatePiece
    {
        ...
        public string DatePieceToString(int value, bool showEmpty, string separator)
        {
            if (value > 1)
        ...
        public abstract string ToStr(DateTime startDate, DateTime endDate, bool showEmpty, string separator);
